            ...
            <tr class="border-t border-gray-300">
              ...
              <td class="p-4 whitespace-no-wrap border-none text-xs font-medium">
                <div class="flex items-center justify-center space-x-3">
                  ...
                  <a href="#" class="bg-gray-300 text-p_blue-500 py-1 px-2 rounded cursor-pointer">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                  </a>
                  <a href="#" class="bg-p_blue-500 text-white py-1 pl-2 pr-3 rounded cursor-pointer flex items-center">
